...
@Entity
public class UnleadedSale extends Model {
    ...
    public UnleadedSale(Long id, String date, double unitSP, double unitNet, double unitCP, double unitProfit, int qtySold, int valSold, int net, double profit)
    {
        this.id = id;
        this.date = date;
        this.unitSP = unitSP;
    ...
    public static Finder<Long,UnleadedSale> find = new Finder<Long,UnleadedSale>(UnleadedSale.class);

    public static List<UnleadedSale> findAll(){
        return UnleadedSale.find.all();
    }
